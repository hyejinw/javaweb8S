	      ...
	      buttons: [
	        {
	          ...
	          link: {
	            ...
	            webUrl: 'http://localhost:9090/javaweb8S/community/reflectionDetail?idx=${vo.idx}', */
 	            mobileWebUrl: 'http://49.142.157.251:9090/javaweb8S/about/noticeDetail?idx=${vo.idx}',
	            webUrl: 'http://49.142.157.251:9090/javaweb8S/about/noticeDetail?idx=${vo.idx}', 
	          },
	        },
	      ],
	    });
