...
<head>
	...
	<script>
		...
		$(document).ready(function(){
			if(sessionStorage.getItem('memMyPageAskSW') == 'ON') {
				sessionStorage.removeItem('memMyPageAskSW');
			}
			if(sessionStorage.getItem('memMyPageAskInsertSW') == 'ON') {
				sessionStorage.removeItem('memMyPageAskInsertSW');
			}
		});
		
		// 문의 상세창
		function askDetail(idx) {
			sessionStorage.setItem('memMyPageAskSW', 'ON');
			location.href = "${ctp}/about/askDetail?idx="+idx;
		}
		// 문의 등록
		function insertCheck() {
			sessionStorage.setItem('memMyPageAskInsertSW', 'ON');
		...
		<div class="container-xl">
			<div class="row">
 				...
 				<div class="col-6 text-center">
					<h2 class="text-center" style="margin:0px auto; font-size:25px; font-weight:bold; padding-bottom:20px">문의 관리</h2>
 				</div>
