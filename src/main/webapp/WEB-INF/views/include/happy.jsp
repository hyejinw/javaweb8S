...
<div class="topNav">
 ...
 <!-- Navbar (sit on top) -->
  <div class="w3-bar w3-card" id="myNavbar" style="background-color:#FAFAFA">
  	<a href="#home" class="w3-bar-item w3-button w3-wide">
    	<img src="${ctp}/resources/images/logo.png" style="width:100%; height:100%; max-width:200px" class="w3-hover-opacity">
    </a>
