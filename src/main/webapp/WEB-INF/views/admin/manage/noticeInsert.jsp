...
<head>
	...
	<script>
		...
		function noticeInsert() {
			let noticeTitle = noticeInsertForm.noticeTitle.value;
			...
			if(!regex1.test(noticeTitle)){
				...
				noticeInsertForm.noticeTitle.focus();
		    return false;
		  }
	...
	<div class="w3-main" style="margin-left:300px; margin-top:43px; padding-top:50px">
	 	...
	 	<div class="table-responsive" style="width:90%; margin:0px auto; padding:40px 50px 100px 50px" class="border">
	 		<div style="background-color:white; padding:20px; margin-bottom:30px">
				...
				<div style="text-align:center"><span class="text-center" style="font-size:30px; text-align:center; font-weight:500">공지사항 등록</span></div>
		  	...
		  	<form name="noticeInsertForm" method="post">
					<div class="table-responsive">
				      ...
				      <tr>
				        ...
				        <td>
									<label for="type1"><input type="radio" name="noticeOpen" id="type1" value="공개" checked>&nbsp;&nbsp;공개</label>
									<label for="type2"><input type="radio" name="noticeOpen" id="type2" value="비공개" class="ml-4">&nbsp;&nbsp;비공개</label>
				        </td>
				      </tr>
				      <tr>
				        <th>상단 고정</th>
				        <td>
									<label for="important"><input type="checkbox" name="important" id="important"/>&nbsp;&nbsp;고정</label>
				        </td>
				      </tr>
				      <tr>
				      ...
				      <tr>
				        ...
				        <td>
				        	<select name="category" id="category" class="form-control">
										<option value="책(의)세계" selected>책(의)세계</option>							
										<option value="3개의책">3개의책</option>							
									</select>
				        </td>
				      </tr>
				      <tr>
				        <td colspan="2">
				        	<textarea rows="100" name="noticeContent" id="CKEDITOR" class="form-control"></textarea>
					        <script>
				      ...
				      <tr>
				        <td colspan="2" class="text-center">
					        <div style="margin-top:20px">
										<button type="button" onclick="noticeInsert()" class="btn2" style="background-color:#F5EBE0; font-size: 0.9em; border-color:#282828; color:black">등록</button>
					        </div>
				        </td>
				      </tr>
					  </table>
