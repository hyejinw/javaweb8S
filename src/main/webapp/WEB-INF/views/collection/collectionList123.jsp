...
<head>
	...
	<script>
    	...
    	if(sort == '컬렉션') {
	    	...
	    	location.href = "${ctp}/collection/colProductList?pag=${pageVO.pag}&pageSize=${pageVO.pageSize}&search=${search}&sort="+sort;
    	}
		}
	</script>
</head>
			...
			<c:forEach var="vo" items="${vos}" varStatus="st">
				<div class="col" <c:if test="${cnt % 2 != 0}">style="margin-left:80px"</c:if>>
					...
					<a href="#;" class="banner_img">
					  <img src="https://cdn.pixabay.com/photo/2020/02/13/21/21/lighthouse-4846854__340.jpg" alt="땡땡땡 배경">
					  <p class="hover_text">이미지에 마우스를 올리면 나타나는 텍스트입니다.</p>
					</a>
