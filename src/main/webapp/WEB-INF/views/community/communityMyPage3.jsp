		 			...
		 			<div style="margin:50px 0px 0px 0px">
		 				<div class="row">
		 					...
		 					<div class="col-4 text-right pr-5">
		 						<button class="btn btn-outline-dark btn-sm" onclick="bookSaveOpen('bookSave1')">편집</button>
		 						<button class="btn btn-outline-dark btn-sm" style="display:none">완료</button>
		 					</div>
		 				</div>
						...
						<div id="bookSave1" class="w3-container w3-hide">
						  ...
						  <div id="infoBox">
					  		<div class="row">
							  	...
							  	<c:forEach var="bookSave1VO" items="${bookSave1VOS}">
						  			<div class="col">
						  				<img src="${bookSave1VO.thumbnail}"/>
						  			</div>
							  	...
							  	<c:if test="${bookSave1VOcnt % 8 != 0}">
							  		<c:forEach var="i" begin="0" end="${8 - (bookSave1VOcnt % 8)}">
