		  ...
		  <div class="table-responsive">
		    	...
		    	<c:set var="curScrStartNo" value="${pageVO.curScrStartNo}" />
 		    	<c:forEach var="vo" items="${vos}" varStatus="st">
			      <tr>
			      	<td rowspan="1">${curScrStartNo}</td>
			        <td>
	        			<div style="font-size:20px; font-weight:bold;">
			        		<a href="${ctp}/">${vo.title}</a><!-- 상세페이지 -->
	        			</div>
	        			<div style="height:150px; padding:10px 50px 30px 50px;">
			        		<br/><a href="${ctp}/">${fn:substring(vo.content,0,200)}<c:if test="${fn:length(vo.content) > 200}">...</c:if></a>
	        			</div>
	        			<div class="row">
	        				<div class="col-6"> 
				        		<a href="${ctp}/">  <!-- 회원 페이지 -->
					        		<img src="${ctp}/admin/member/${vo.memPhoto}" style="width:35px"/>&nbsp;&nbsp;&nbsp;
					        		${vo.memNickname}
				        		</a>
	        				</div>
	        				<div class="col-6 text-right"> 
				        		<a href="${ctp}/">
					        		...
					        		<c:if test="${(vo.memNickname == sNickname) || (sNickname == '관리자')}">
					        			&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-heart"></i>&nbsp;&nbsp;${vo.refSave}
					        		</c:if>
				        		</a>
	        				</div>
			        ...
			        <td rowspan="1" class="text-center"><!-- 책 상세 페이지 -->
			        	<c:if test="${!empty vo.thumbnail}"><img src="${vo.thumbnail}" style="width:100px"/></c:if>
		        	</td>
			      </tr>
