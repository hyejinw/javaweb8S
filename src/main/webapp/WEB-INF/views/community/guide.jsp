		...
		<div class="row" style="margin: 100px 50px 200px 100px">
			<div class="col-10" style="padding:30px 70px 0px 30px;">
				<div style="margin-bottom:100px">
					...
					<div class="content">
						3개의 책은 매일 새로운 이야기와 물음으로 책 읽기의 즐거움을 나누는 공간입니다. 모든 콘텐츠가 그러한 영감을 주는 것은 아니므로 3개의 책은 커뮤니티 가이드라인을 마련해두고 있습니다. 가이드라인은 3개의 책의 허용 가능 사용 정책이므로 3개의 책에 없어야 할 콘텐츠를 발견하신다면 3개의 책에 신고해주세요 . 3개의 책은 회원님의 신고를 통해 3개의 책 운영 기준을 심층적으로 분석하고 발전시키며 주제 전문가들과 협력하여 3개의 책의 가이드라인을 알리고 업데이트합니다. 
					</div>
				</div>
				...
				<div style="margin-bottom:100px">
					...
					<div class="content">
						...
						3개의 책은 사용자들이 이해하기 쉽도록 명확하고 투명한 요구사항을 제시하고자 최선을 다하고 있습니다. 이에 관해 궁금한 점 또는 문제가 있는 경우 3개의 책에 문의해주세요.
					</div>
				</div>
